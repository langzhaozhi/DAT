 ...
 * 这个概念的本质是一个客观实在，和谁采纳与否无关，和谁提出无关）
 ...
 * 因此这个反向DAT就是正向DAT的对偶，称为对偶DAT。以后当说对偶DAT的时候，其实是隐含了字符串倒置运算作为对偶运算f的，这点要注意! 这样，
 * <b>对对偶DAT树执行前缀匹配的时候本质上进行的是对正向DAT树执行后缀匹配，这恰好就是这里要要的结果!</b><br/>
